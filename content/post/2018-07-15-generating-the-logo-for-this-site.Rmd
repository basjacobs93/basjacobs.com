...
![Dividing the Netherlands into around 1100 cells](/post/2018-07-15-generating-the-logo-for-this-site_files/ahn.png){width=400px}
...
![Sideview of the Netherlands](/post/2018-07-15-generating-the-logo-for-this-site_files/sideview.png){width=400px}

This plot displays the country as if we were standing in Germany and looking at the Netherlands without the ability to see perspective. There are some weird values here and there, but overall it looks like can be expected. It is too rough to use as a plot; we should apply some smoothing to make it prettier.  
...
ggplot(df, aes(x = x, y = elevation)) +
  ...
  theme_void()
```
![Sideview of the Netherlands when squinting](/post/2018-07-15-generating-the-logo-for-this-site_files/sideview_smooth.png){width=400px}
