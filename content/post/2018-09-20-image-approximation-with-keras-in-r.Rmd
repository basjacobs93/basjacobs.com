...
plot(im, axes = FALSE)
```
![A godwit. Source: pixabay.com](/post/2018-09-20-image-approximation-with-keras-in-r_files/image.png){width=600px}
...
```
![Training progress](/post/2018-09-20-image-approximation-with-keras-in-r_files/trainplot.png)
...
```
![The network learned a gradient](/post/2018-09-20-image-approximation-with-keras-in-r_files/model1.png){width=600px}
...
as.cimg(df_out) %>% list(im, .) %>%
  imappend("x") %>% plot(axes = F)
```
![Some features of the bird appear](/post/2018-09-20-image-approximation-with-keras-in-r_files/model2.png){width=600px}
...
as.cimg(df_out) %>% list(im, .) %>%
  imappend("x") %>% plot(axes=F)
```
![The image is nicely recovered](/post/2018-09-20-image-approximation-with-keras-in-r_files/model3.png){width=600px}
